...
def once():
    ...
    if g is None:
        ...
        rv.message = "Finished: " + datetime.datetime.utcnow().isoformat(timespec='seconds')
...
def _compute(params):
    if params.mode == "Julia":
        return _julia(complex(params.density_r, params.density_i), params.size, params.iterations)
